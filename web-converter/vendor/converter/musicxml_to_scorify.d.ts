...
export function convert_musicxml_file_wasm(bytes: Uint8Array, filename: string, options_json: string): string;

export function convert_musicxml_text_wasm(xml: string): string;

export function convert_musicxml_text_with_options_wasm(xml: string, options_json: string): string;
